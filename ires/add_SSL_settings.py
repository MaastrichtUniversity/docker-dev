...
SSL_settings = {
    "irods_ssl_certificate_chain_file": "/etc/irods/SSL/ires.dh.local.crt",
    "irods_ssl_certificate_key_file": "/etc/irods/SSL/ires.dh.local.key",
