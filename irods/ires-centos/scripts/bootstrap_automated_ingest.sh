...
python -m virtualenv -p python3.9 /etc/irods/rodssync
source /etc/irods/rodssync/bin/activate
pip install irods_capability_automated_ingest

patch /etc/irods/rodssync/lib/python3.9/site-packages/irods_capability_automated_ingest/sync_actions.py /var/lib/irods/Add_failure_check.patch
