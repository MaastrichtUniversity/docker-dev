...
#echo "PRINT ENV VAR BEFORE"
#echo "$ENV_S3_RESC_NAME"
#echo "$ENV_S3_HOST"
#echo "$S3_AUTH_FILE"
...
then
  echo "Create replication resource";
...
echo "Add child resource to repl resource";
...
#
#echo "Add storage pricing to resources";
